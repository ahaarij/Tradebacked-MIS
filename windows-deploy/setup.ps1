...
# 4. Task Scheduler: every 5 minutes
...
--------------------------------------------------------------------
 ...
 Next: add dashboard.cred-desk.com to your Cloudflare config.yml
 then: cloudflared.exe tunnel route dns mis-app dashboard.cred-desk.com
 then: Restart-Service cloudflared
--------------------------------------------------------------------
